...
export function ImportReviewViewer() {
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-lg border border-ink/10 bg-white p-6 shadow-sm">
        <h2 className="text-lg font-semibold text-ink">Schema metadata</h2>
        <div className="mt-5 grid gap-3 sm:grid-cols-3">
          <SummaryItem label="Schema version" value={data?.schemaVersion} />
          <SummaryItem label="Generated by" value={data?.generatedBy} />
          <SummaryItem label="Generated at" value={data?.generatedAt} />
        </div>
      </section>
